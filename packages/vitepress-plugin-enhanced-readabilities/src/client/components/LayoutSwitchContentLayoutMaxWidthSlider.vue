    ...
    >
      <div ref="menuTitleElementRef" flex items-center>
        <MenuTitle
          ...
          :aria-label="
            t('layoutSwitch.contentLayoutMaxWidth.titleAriaLabel') ||
          ...
          <div space-y-2 class="VPNolebaseEnhancedReadabilitiesMenu">
            ...
            >
              <h5 text="sm" mb-2 flex="~" items-center align-middle>
                ...
                <span font-semibold>{{
                  t("layoutSwitch.contentLayoutMaxWidth.slider")
                }}</span>
              </h5>
              <span>{{
                t("layoutSwitch.contentLayoutMaxWidth.sliderHelpMessage")
              }}</span>
            </div>
          </div>
        </MenuHelp>
      ...
      <NuInputSlider
        ...
        :aria-label="
          t('layoutSwitch.contentLayoutMaxWidth.optionFullWidthAriaLabel')
        "
        :disabled="disabled"
        :min="minScaled"
        :max="maxScaled"
