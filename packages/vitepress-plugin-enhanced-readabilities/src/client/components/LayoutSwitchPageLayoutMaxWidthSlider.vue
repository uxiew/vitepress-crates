...
import { NuInputSlider, NuVerticalTransition } from "@ver5/vitepress-ui";
...
<template>
  <NuVerticalTransition :duration="200">
    <div
      v-show="
        layoutMode === LayoutMode.SidebarWidthAdjustableOnly ||
    ...
    >
      <div ref="menuTitleElementRef" flex items-center>
        <MenuTitle
          ...
          :aria-label="
            t('layoutSwitch.pageLayoutMaxWidth.titleAriaLabel') ||
        ...
        >
          ...
          <p text="sm" mb-2 max-w-100>
            <span>{{
              t("layoutSwitch.pageLayoutMaxWidth.titleHelpMessage")
            }}</span>
          </p>
          <div space-y-2 class="VPNolebaseEnhancedReadabilitiesMenu">
            ...
            >
              <h5 text="sm" mb-2 flex="~" items-center align-middle>
                ...
                <span font-semibold>{{
                  t("layoutSwitch.pageLayoutMaxWidth.slider")
                }}</span>
              </h5>
              <span>{{
                t("layoutSwitch.pageLayoutMaxWidth.sliderHelpMessage")
              }}</span>
            </div>
          </div>
        </MenuHelp>
