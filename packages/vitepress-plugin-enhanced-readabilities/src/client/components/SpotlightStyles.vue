...
import { NuInputHorizontalRadioGroup } from "@ver5/vitepress-ui";
    ...
    >
      <div ref="menuTitleElementRef" relative flex items-center>
        <MenuTitle
          ...
          :aria-label="
            t('spotlight.styles.titleAriaLabel') || t('spotlight.styles.title')
          "
          :disabled="disabled"
          flex="1"
          pr-4
          ...
          <div space-y-2 class="VPNolebaseEnhancedReadabilitiesMenu">
            ...
            >
              <h5 text="sm" mb-2>
                ...
                <span font-semibold>{{
                  t("spotlight.styles.optionUnder")
                }}</span>
              </h5>
            ...
            >
              <h5 text="sm" mb-2>
                ...
                <span font-semibold>{{
                  t("spotlight.styles.optionAside")
                }}</span>
              </h5>
