...
type AlignMark = keyof Delimiters
 ...
 *
 */
const alignRule: RuleBlock = function alignRule(state, startLine, endLine, silent) {
  ...
  const iLen = 3;
  let open: AlignMark = ':--', close: AlignMark = ':--';
  ...
  openDelim = state.src.slice(pos, pos + iLen) as AlignMark;
